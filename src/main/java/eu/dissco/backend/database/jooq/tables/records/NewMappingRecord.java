...
public class NewMappingRecord extends UpdatableRecordImpl<NewMappingRecord> implements Record9<String, Integer, String, String, JSONB, Instant, String, Instant, String> {
    ...
    /**
     * Setter for <code>public.new_mapping.sourcedatastandard</code>.
     */
    ...
    /**
     * Getter for <code>public.new_mapping.sourcedatastandard</code>.
     */
    ...
    public Field<String> field9() {
        return NewMapping.NEW_MAPPING.SOURCEDATASTANDARD;
    }
    ...
    @Override
    public NewMappingRecord value9(String value) {
        setSourcedatastandard(value);
        return this;
    }

    @Override
    public NewMappingRecord values(String value1, Integer value2, String value3, String value4, JSONB value5, Instant value6, String value7, Instant value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NewMappingRecord(String id, Integer version, String name, String description, JSONB mapping, Instant created, String creator, Instant deleted, String sourcedatastandard) {
        super(NewMapping.NEW_MAPPING);
