...
@Schema
public record MasResponseData(@Schema(description = "Handle of the source system") String id,
		@Schema(description = "Type of the object, in this case \"ods:MachineAnnotationService\"",
