...
@Schema
public record SourceSystemRequestSchema(@Schema SourceSystemRequestData data) {

	@Schema
	public record SourceSystemRequestData(
			@Schema(description = "Type of request. For source systems, must be \"ods:SourceSystem\"",
