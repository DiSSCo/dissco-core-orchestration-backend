...
public class ProvenanceService {
	...
	private CreateUpdateTombstoneEvent generateCreateUpdateTombStoneEvent(JsonNode digitalObject,
		...
		return new CreateUpdateTombstoneEvent().withId(entityID)
			...
			.withOdsHasAgents(List.of(createAgent(agent.getSchemaName(), agent.getId(), CREATOR, ORCID, PROV_PERSON),
					createAgent(properties.getName(), properties.getPid(), PROCESSING_SERVICE, DctermsType.DOI.value(),
							PROV_SOFTWARE_AGENT)));
	}
