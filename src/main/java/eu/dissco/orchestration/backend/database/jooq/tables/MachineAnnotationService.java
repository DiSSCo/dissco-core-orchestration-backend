...
public class MachineAnnotationService extends TableImpl<MachineAnnotationServiceRecord> {
	 ...
	 */
	public final TableField<MachineAnnotationServiceRecord, String> ID = createField(DSL.name("id"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.version</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, Integer> VERSION = createField(DSL.name("version"),
			SQLDataType.INTEGER.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.name</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> NAME = createField(DSL.name("name"),
			SQLDataType.VARCHAR.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.created</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, Instant> CREATED = createField(DSL.name("created"),
			SQLDataType.INSTANT.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.modified</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, Instant> MODIFIED = createField(DSL.name("modified"),
			SQLDataType.INSTANT.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.tombstoned</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, Instant> TOMBSTONED = createField(DSL.name("tombstoned"),
			SQLDataType.INSTANT, this, "");

	/**
	 * The column <code>public.machine_annotation_service.creator</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> CREATOR = createField(DSL.name("creator"),
			SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.container_image</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> CONTAINER_IMAGE = createField(
			DSL.name("container_image"), SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.container_image_tag</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> CONTAINER_IMAGE_TAG = createField(
			DSL.name("container_image_tag"), SQLDataType.CLOB.nullable(false), this, "");

	/**
	 * The column <code>public.machine_annotation_service.creative_work_state</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> CREATIVE_WORK_STATE = createField(
			DSL.name("creative_work_state"), SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.machine_annotation_service.source_code_repository</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> SOURCE_CODE_REPOSITORY = createField(
			DSL.name("source_code_repository"), SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.machine_annotation_service.service_availability</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> SERVICE_AVAILABILITY = createField(
			DSL.name("service_availability"), SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.machine_annotation_service.code_maintainer</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> CODE_MAINTAINER = createField(
			DSL.name("code_maintainer"), SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.machine_annotation_service.code_license</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> CODE_LICENSE = createField(DSL.name("code_license"),
			SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.machine_annotation_service.support_contact</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, String> SUPPORT_CONTACT = createField(
			DSL.name("support_contact"), SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.machine_annotation_service.batching_permitted</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, Boolean> BATCHING_PERMITTED = createField(
			DSL.name("batching_permitted"), SQLDataType.BOOLEAN, this, "");

	/**
	 * The column <code>public.machine_annotation_service.time_to_live</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, Integer> TIME_TO_LIVE = createField(
			DSL.name("time_to_live"),
			SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("86400"), SQLDataType.INTEGER)), this,
			"");

	/**
	 * The column <code>public.machine_annotation_service.data</code>.
	 */
	public final TableField<MachineAnnotationServiceRecord, JSONB> DATA = createField(DSL.name("data"),
	...
	private MachineAnnotationService(Name alias, Table<MachineAnnotationServiceRecord> aliased, Field<?>[] parameters,
			Condition where) {
		super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table(), where);
	}

	/**
	 * Create an aliased <code>public.machine_annotation_service</code> table reference
	 */
