...
public class NewMachineAnnotationServicesRecord extends
    UpdatableRecordImpl<NewMachineAnnotationServicesRecord> {

  private static final long serialVersionUID = 1L;

  /**
   * Create a detached NewMachineAnnotationServicesRecord
   */
  public NewMachineAnnotationServicesRecord() {
    super(NewMachineAnnotationServices.NEW_MACHINE_ANNOTATION_SERVICES);
  }

  /**
   * Create a detached, initialised NewMachineAnnotationServicesRecord
   */
  public NewMachineAnnotationServicesRecord(String id, Integer version, String name,
      Instant dateCreated, Instant dateModified, Instant dateTombstoned, String creator,
      String containerImage, String containerImageTag, String creativeWorkState,
      String sourceCodeRepository, String serviceAvailability, String codeMaintainer,
      String codeLicense, String supportContact, Boolean batchingPermitted, Integer timeToLive,
      JSONB data) {
    super(NewMachineAnnotationServices.NEW_MACHINE_ANNOTATION_SERVICES);
  ...
  /**
   * Getter for <code>public.new_machine_annotation_services.id</code>.
   */
  public String getId() {
    return (String) get(0);
  }
  ...
  /**
   * Setter for <code>public.new_machine_annotation_services.id</code>.
   */
  ...
  /**
   * Getter for <code>public.new_machine_annotation_services.version</code>.
   */
  ...
  /**
   * Setter for <code>public.new_machine_annotation_services.version</code>.
   */
  ...
  /**
   * Getter for <code>public.new_machine_annotation_services.name</code>.
   */
  ...
  /**
   * Setter for <code>public.new_machine_annotation_services.name</code>.
   */
  ...
  /**
   * Getter for <code>public.new_machine_annotation_services.creator</code>.
   */
  ...
  /**
   * Setter for <code>public.new_machine_annotation_services.creator</code>.
   */
  ...
  /**
   * Getter for <code>public.new_machine_annotation_services.data</code>.
   */
  ...
  /**
   * Setter for <code>public.new_machine_annotation_services.data</code>.
   */
