...
public class SourceSystem extends TableImpl<SourceSystemRecord> {
	 ...
	 */
	public final TableField<SourceSystemRecord, Instant> TOMBSTONED = createField(DSL.name("tombstoned"),
			SQLDataType.INSTANT, this, "");

	/**
	 * The column <code>public.source_system.mapping_id</code>.
	 */
	public final TableField<SourceSystemRecord, String> MAPPING_ID = createField(DSL.name("mapping_id"),
			SQLDataType.CLOB.nullable(false), this, "");
	...
	public final TableField<SourceSystemRecord, TranslatorType> TRANSLATOR_TYPE = createField(
			DSL.name("translator_type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(TranslatorType.class), this,
			"");
	 ...
	 */
	public final TableField<SourceSystemRecord, String> DWC_DP_LINK = createField(DSL.name("dwc_dp_link"),
			SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.source_system.dwca_link</code>.
	 */
	public final TableField<SourceSystemRecord, String> DWCA_LINK = createField(DSL.name("dwca_link"), SQLDataType.CLOB,
			this, "");
	 ...
	 */
	public final TableField<SourceSystemRecord, String[]> FILTERS = createField(DSL.name("filters"),
			SQLDataType.CLOB.array(), this, "");
