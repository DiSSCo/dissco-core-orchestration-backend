...
public class NewMachineAnnotationServices extends TableImpl<NewMachineAnnotationServicesRecord> {
     ...
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.new_machine_annotation_services.version</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, Integer> VERSION = createField(DSL.name("version"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.new_machine_annotation_services.name</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.date_created</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, Instant> DATE_CREATED = createField(DSL.name("date_created"), SQLDataType.INSTANT.nullable(false), this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.date_modified</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, Instant> DATE_MODIFIED = createField(DSL.name("date_modified"), SQLDataType.INSTANT.nullable(false), this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.date_tombstoned</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, Instant> DATE_TOMBSTONED = createField(DSL.name("date_tombstoned"), SQLDataType.INSTANT, this, "");

    /**
     * The column <code>public.new_machine_annotation_services.creator</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> CREATOR = createField(DSL.name("creator"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.container_image</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> CONTAINER_IMAGE = createField(DSL.name("container_image"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.container_image_tag</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> CONTAINER_IMAGE_TAG = createField(DSL.name("container_image_tag"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.creative_work_state</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> CREATIVE_WORK_STATE = createField(DSL.name("creative_work_state"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.source_code_repository</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> SOURCE_CODE_REPOSITORY = createField(DSL.name("source_code_repository"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.service_availability</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> SERVICE_AVAILABILITY = createField(DSL.name("service_availability"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.code_maintainer</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> CODE_MAINTAINER = createField(DSL.name("code_maintainer"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.code_license</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> CODE_LICENSE = createField(DSL.name("code_license"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.support_contact</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, String> SUPPORT_CONTACT = createField(DSL.name("support_contact"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.batching_permitted</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, Boolean> BATCHING_PERMITTED = createField(DSL.name("batching_permitted"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column
     * <code>public.new_machine_annotation_services.time_to_live</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, Integer> TIME_TO_LIVE = createField(DSL.name("time_to_live"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("86400"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.new_machine_annotation_services.data</code>.
     */
    public final TableField<NewMachineAnnotationServicesRecord, JSONB> DATA = createField(DSL.name("data"), SQLDataType.JSONB.nullable(false), this, "");

    private NewMachineAnnotationServices(Name alias, Table<NewMachineAnnotationServicesRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private NewMachineAnnotationServices(Name alias, Table<NewMachineAnnotationServicesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table(), where);
    }

    /**
     * Create an aliased <code>public.new_machine_annotation_services</code>
     * table reference
     */
    ...
    /**
     * Create a <code>public.new_machine_annotation_services</code> table
     * reference
     */
    ...
    public NewMachineAnnotationServices where(Condition condition) {
        return new NewMachineAnnotationServices(getQualifiedName(), aliased() ? this : null, null, condition);
    }
