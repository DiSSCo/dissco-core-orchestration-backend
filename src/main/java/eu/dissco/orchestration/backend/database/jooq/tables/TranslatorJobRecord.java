...
import eu.dissco.orchestration.backend.database.jooq.enums.ErrorCode;
import eu.dissco.orchestration.backend.database.jooq.enums.JobState;
import eu.dissco.orchestration.backend.database.jooq.tables.records.TranslatorJobRecordRecord;
import org.jooq.*;
