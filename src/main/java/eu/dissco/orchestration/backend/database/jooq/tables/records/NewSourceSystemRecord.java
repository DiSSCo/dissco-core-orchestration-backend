...
public class NewSourceSystemRecord extends UpdatableRecordImpl<NewSourceSystemRecord> {
     ...
     */
    public NewSourceSystemRecord(String id, String name, String endpoint, Instant dateCreated, Instant dateModified, Instant dateTombstoned, String mappingId, Integer version, String creator, TranslatorType translatorType, JSONB data) {
        super(NewSourceSystem.NEW_SOURCE_SYSTEM);
