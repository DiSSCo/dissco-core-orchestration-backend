...
public class MachineAnnotationServices extends TableImpl<MachineAnnotationServicesRecord> {
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, Boolean> BATCHING_PERMITTED = createField(
      DSL.name("batching_permitted"), SQLDataType.BOOLEAN, this, "");
  /**
   * The column <code>public.machine_annotation_services.time_to_live</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, Integer> TIME_TO_LIVE = createField(
  ...
  public MachineAnnotationServices where(Condition condition) {
    return new MachineAnnotationServices(getQualifiedName(), aliased() ? this : null, null,
        condition);
  }
