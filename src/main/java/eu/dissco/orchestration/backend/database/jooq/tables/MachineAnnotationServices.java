...
public class MachineAnnotationServices extends TableImpl<MachineAnnotationServicesRecord> {
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column <code>public.machine_annotation_services.version</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, Integer> VERSION = createField(
      DSL.name("version"), SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.machine_annotation_services.name</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> NAME = createField(
      DSL.name("name"), SQLDataType.VARCHAR.nullable(false), this, "");

  /**
   * The column <code>public.machine_annotation_services.created</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, Instant> CREATED = createField(
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, String> ADMINISTRATOR = createField(
      DSL.name("administrator"), SQLDataType.CLOB.nullable(false), this, "");

  /**
   * The column
   * <code>public.machine_annotation_services.container_image</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> CONTAINER_IMAGE = createField(
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, String> CONTAINER_IMAGE_TAG = createField(
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, JSONB> TARGET_DIGITAL_OBJECT_FILTERS = createField(
      DSL.name("target_digital_object_filters"), SQLDataType.JSONB, this, "");

  /**
   * The column
   * <code>public.machine_annotation_services.service_description</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> SERVICE_DESCRIPTION = createField(
      DSL.name("service_description"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.machine_annotation_services.service_state</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> SERVICE_STATE = createField(
      DSL.name("service_state"), SQLDataType.CLOB, this, "");

  /**
   * The column
   * <code>public.machine_annotation_services.source_code_repository</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> SOURCE_CODE_REPOSITORY = createField(
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, String> SERVICE_AVAILABILITY = createField(
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, String> CODE_MAINTAINER = createField(
      DSL.name("code_maintainer"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.machine_annotation_services.code_license</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> CODE_LICENSE = createField(
      DSL.name("code_license"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.machine_annotation_services.dependencies</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String[]> DEPENDENCIES = createField(
      DSL.name("dependencies"), SQLDataType.CLOB.array(), this, "");

  /**
   * The column
   * <code>public.machine_annotation_services.support_contact</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> SUPPORT_CONTACT = createField(
   ...
   */
  public final TableField<MachineAnnotationServicesRecord, String> SLA_DOCUMENTATION = createField(
      DSL.name("sla_documentation"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.machine_annotation_services.topicname</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, String> TOPICNAME = createField(
      DSL.name("topicname"), SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.machine_annotation_services.maxreplicas</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, Integer> MAXREPLICAS = createField(
      DSL.name("maxreplicas"), SQLDataType.INTEGER, this, "");

  /**
   * The column <code>public.machine_annotation_services.deleted_on</code>.
   */
  public final TableField<MachineAnnotationServicesRecord, Instant> DELETED_ON = createField(
      DSL.name("deleted_on"), SQLDataType.INSTANT, this, "");
  ...
  /**
   * Create an aliased <code>public.machine_annotation_services</code> table reference
   */
  ...
  public <O extends Record> MachineAnnotationServices(Table<O> child,
      ForeignKey<O, MachineAnnotationServicesRecord> key) {
  ...
  public <U> SelectField<U> mapping(
      Function20<? super String, ? super Integer, ? super String, ? super Instant, ? super String, ? super String, ? super String, ? super JSONB, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String[], ? super String, ? super String, ? super String, ? super Integer, ? super Instant, ? extends U> from) {
