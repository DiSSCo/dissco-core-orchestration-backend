...
import eu.dissco.orchestration.backend.database.jooq.Indexes;
...
public class Handles extends TableImpl<HandlesRecord> {
   ...
   */
  public final TableField<HandlesRecord, byte[]> HANDLE = createField(DSL.name("handle"),
      SQLDataType.BLOB.nullable(false), this, "");

  /**
   * The column <code>public.handles.idx</code>.
   */
  public final TableField<HandlesRecord, Integer> IDX = createField(DSL.name("idx"),
      SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * The column <code>public.handles.type</code>.
   */
  public final TableField<HandlesRecord, byte[]> TYPE = createField(DSL.name("type"),
      SQLDataType.BLOB, this, "");

  /**
   * The column <code>public.handles.data</code>.
   */
  public final TableField<HandlesRecord, byte[]> DATA = createField(DSL.name("data"),
      SQLDataType.BLOB, this, "");

  /**
   * The column <code>public.handles.ttl_type</code>.
   */
  public final TableField<HandlesRecord, Short> TTL_TYPE = createField(DSL.name("ttl_type"),
      SQLDataType.SMALLINT, this, "");

  /**
   * The column <code>public.handles.ttl</code>.
   */
  public final TableField<HandlesRecord, Integer> TTL = createField(DSL.name("ttl"),
      SQLDataType.INTEGER, this, "");

  /**
   * The column <code>public.handles.timestamp</code>.
   */
  public final TableField<HandlesRecord, Long> TIMESTAMP = createField(DSL.name("timestamp"),
      SQLDataType.BIGINT, this, "");

  /**
   * The column <code>public.handles.refs</code>.
   */
  public final TableField<HandlesRecord, String> REFS = createField(DSL.name("refs"),
      SQLDataType.CLOB, this, "");

  /**
   * The column <code>public.handles.admin_read</code>.
   */
  public final TableField<HandlesRecord, Boolean> ADMIN_READ = createField(DSL.name("admin_read"),
      SQLDataType.BOOLEAN, this, "");

  /**
   * The column <code>public.handles.admin_write</code>.
   */
  public final TableField<HandlesRecord, Boolean> ADMIN_WRITE = createField(DSL.name("admin_write"),
      SQLDataType.BOOLEAN, this, "");

  /**
   * The column <code>public.handles.pub_read</code>.
   */
  public final TableField<HandlesRecord, Boolean> PUB_READ = createField(DSL.name("pub_read"),
      SQLDataType.BOOLEAN, this, "");

  /**
   * The column <code>public.handles.pub_write</code>.
   */
  public final TableField<HandlesRecord, Boolean> PUB_WRITE = createField(DSL.name("pub_write"),
      SQLDataType.BOOLEAN, this, "");
  ...
  public <U> SelectField<U> mapping(
      Function12<? super byte[], ? super Integer, ? super byte[], ? super byte[], ? super Short, ? super Integer, ? super Long, ? super String, ? super Boolean, ? super Boolean, ? super Boolean, ? super Boolean, ? extends U> from) {
