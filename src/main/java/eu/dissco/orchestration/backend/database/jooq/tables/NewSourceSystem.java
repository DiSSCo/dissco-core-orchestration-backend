...
public class NewSourceSystem extends TableImpl<NewSourceSystemRecord> {
   ...
   */
  public final TableField<NewSourceSystemRecord, String> ID = createField(DSL.name("id"),
      SQLDataType.CLOB.nullable(false), this, "");
  /**
   * The column <code>public.new_source_system.name</code>.
   */
  public final TableField<NewSourceSystemRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.CLOB.nullable(false), this, "");
  /**
   * The column <code>public.new_source_system.endpoint</code>.
   */
  public final TableField<NewSourceSystemRecord, String> ENDPOINT = createField(
      DSL.name("endpoint"), SQLDataType.CLOB.nullable(false), this, "");
  /**
   * The column <code>public.new_source_system.date_created</code>.
   */
  public final TableField<NewSourceSystemRecord, Instant> DATE_CREATED = createField(
      DSL.name("date_created"), SQLDataType.INSTANT.nullable(false), this, "");
  /**
   * The column <code>public.new_source_system.date_modified</code>.
   */
  public final TableField<NewSourceSystemRecord, Instant> DATE_MODIFIED = createField(
   ...
   */
  public final TableField<NewSourceSystemRecord, Instant> DATE_TOMBSTONED = createField(
      DSL.name("date_tombstoned"), SQLDataType.INSTANT, this, "");
  /**
   * The column <code>public.new_source_system.mapping_id</code>.
   */
  public final TableField<NewSourceSystemRecord, String> MAPPING_ID = createField(
      DSL.name("mapping_id"), SQLDataType.CLOB.nullable(false), this, "");
  /**
   * The column <code>public.new_source_system.version</code>.
   */
  public final TableField<NewSourceSystemRecord, Integer> VERSION = createField(DSL.name("version"),
   ...
   */
  public final TableField<NewSourceSystemRecord, String> CREATOR = createField(DSL.name("creator"),
      SQLDataType.CLOB.nullable(false), this, "");
  /**
   * The column <code>public.new_source_system.translator_type</code>.
   */
  public final TableField<NewSourceSystemRecord, TranslatorType> TRANSLATOR_TYPE = createField(
      DSL.name("translator_type"), SQLDataType.VARCHAR.asEnumDataType(TranslatorType.class), this,
      "");
  /**
   * The column <code>public.new_source_system.data</code>.
   */
  public final TableField<NewSourceSystemRecord, JSONB> DATA = createField(DSL.name("data"),
