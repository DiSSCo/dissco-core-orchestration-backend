...
public class MachineAnnotationServiceRecord extends UpdatableRecordImpl<MachineAnnotationServiceRecord> {
	...
	/**
	 * Setter for <code>public.machine_annotation_service.container_image</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.container_image</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.container_image_tag</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.container_image_tag</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.creative_work_state</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.creative_work_state</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.source_code_repository</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.source_code_repository</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.service_availability</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.service_availability</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.code_maintainer</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.code_maintainer</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.support_contact</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.support_contact</code>.
	 */
	...
	/**
	 * Setter for <code>public.machine_annotation_service.batching_permitted</code>.
	 */
	...
	/**
	 * Getter for <code>public.machine_annotation_service.batching_permitted</code>.
	 */
	 ...
	 */
	public MachineAnnotationServiceRecord(String id, Integer version, String name, Instant created, Instant modified,
			Instant tombstoned, String creator, String containerImage, String containerImageTag,
			String creativeWorkState, String sourceCodeRepository, String serviceAvailability, String codeMaintainer,
			String codeLicense, String supportContact, Boolean batchingPermitted, Integer timeToLive, JSONB data) {
		super(MachineAnnotationService.MACHINE_ANNOTATION_SERVICE);
