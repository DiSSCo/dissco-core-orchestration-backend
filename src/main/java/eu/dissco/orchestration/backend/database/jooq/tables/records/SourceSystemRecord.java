...
public class SourceSystemRecord extends UpdatableRecordImpl<SourceSystemRecord> {
	 ...
	 */
	public SourceSystemRecord(String id, Integer version, String name, String endpoint, Instant created,
			Instant modified, Instant tombstoned, String mappingId, String creator, TranslatorType translatorType,
			JSONB data, String dwcDpLink, String dwcaLink, byte[] eml, String[] filters) {
		super(SourceSystem.SOURCE_SYSTEM);
