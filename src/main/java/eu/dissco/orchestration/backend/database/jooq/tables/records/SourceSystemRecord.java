...
public class SourceSystemRecord extends UpdatableRecordImpl<SourceSystemRecord> implements Record10<String, String, String, String, Instant, Instant, String, Integer, String, TranslatorType> {
    ...
    @Override
    public Row10<String, String, String, String, Instant, Instant, String, Integer, String, TranslatorType> valuesRow() {
    ...
    @Override
    public Field<TranslatorType> field10() {
    ...
    @Override
    public TranslatorType component10() {
    ...
    @Override
    public SourceSystemRecord value10(TranslatorType value) {
        setTranslatorType(value);
        return this;
    }

    @Override
    public SourceSystemRecord values(String value1, String value2, String value3, String value4, Instant value5, Instant value6, String value7, Integer value8, String value9, TranslatorType value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
