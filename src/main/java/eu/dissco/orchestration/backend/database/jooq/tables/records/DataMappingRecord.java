...
public class DataMappingRecord extends UpdatableRecordImpl<DataMappingRecord> {
   ...
   */
  public DataMappingRecord(String id, Integer version, String name, Instant dateCreated,
      Instant dateModified, Instant dateTombstoned, String creator, String mappingDataStandard,
      JSONB data) {
    super(DataMapping.DATA_MAPPING);
