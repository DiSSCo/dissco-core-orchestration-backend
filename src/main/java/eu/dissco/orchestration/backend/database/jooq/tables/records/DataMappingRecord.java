...
public class DataMappingRecord extends UpdatableRecordImpl<DataMappingRecord> {
	 ...
	 */
	public DataMappingRecord(String id, Integer version, String name, Instant created, Instant modified,
			Instant tombstoned, String creator, String mappingDataStandard, JSONB data) {
		super(DataMapping.DATA_MAPPING);
