...
class ControllerUtilsTest {
		...
		return Stream.of(
				Arguments.of(
						new HashMap<String, Object>(
								Map.of("orcid", BARE_ORCID, "family_name", "Attenborough", "given_name", "David")),
						AgentUtils.createAgent("David Attenborough", ORCID, CREATOR, "orcid", Type.SCHEMA_PERSON)),
				Arguments.of(new HashMap<String, Object>(Map.of("orcid", ORCID, "given_name", "David")),
						AgentUtils.createAgent("David", ORCID, CREATOR, "orcid", Type.SCHEMA_PERSON)),
				Arguments.of(new HashMap<String, Object>(Map.of("orcid", BARE_ORCID, "family_name", "Attenborough")),
						AgentUtils.createAgent("Attenborough", ORCID, CREATOR, "orcid", Type.SCHEMA_PERSON)));
	}
	...
	void testNoOrcid() {
		// Given
		var claims = new HashMap<String, Object>(Map.of("family_name", "Attenborough", "given_name", "David"));
		givenAuthentication(claims);
